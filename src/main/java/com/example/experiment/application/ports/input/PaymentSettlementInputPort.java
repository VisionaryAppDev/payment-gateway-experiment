...
public class PaymentSettlementInputPort implements PaymentSettlementUseCase {
    ...
    public SettlementResponse settle(PaymentSettlementRequest paymentSettlementRequest) {
        PaymentInquiryRequest paymentInquiryRequest = new PaymentInquiryRequest(paymentSettlementRequest.productCode(), paymentSettlementRequest.type());
        PaymentDetail paymentDetail = inquiryPaymentInfoUseCase.inquiry(paymentInquiryRequest);
